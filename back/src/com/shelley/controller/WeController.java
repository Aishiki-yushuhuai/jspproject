...
public class WeController extends HttpServlet {
	...
	private void list(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageHelper<WeDTO> pageHelper = weService.getAllWithWeDTO(menuId,page,Commons.PAGE_SIZE);
		request.setAttribute("pageHelper", pageHelper);
		request.getRequestDispatcher("/WEB-INF/our/we.jsp").forward(request, response);
	}
	...
	private void delete(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        response.sendRedirect("list.wec?menuId=6");
    }
	...
	protected void addedit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String menuIdStr = request.getParameter("menuId");
        try {
        	Integer menu = Integer.parseInt(menuIdStr.trim());
            if (menu != null){
                forwordPath = "/WEB-INF/our/addwe.jsp";
	...
	private void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		We we = new We();
		we.setManager((int)(session.getAttribute("manager")));
